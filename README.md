...
4. **Governance:** All tables are registered in **Unity Catalog** for centralized discovery.
5. **Orchestration:** **Azure Data Factory** triggers notebooks on a scheduled basis.

## 🛠️ Tech Stack
* **Orchestration:** Azure Data Factory (ADF)
* **Compute:** Azure Databricks (Runtime 13.x+)
...
4. **Trigger:** Set to run on a [Daily/Hourly] schedule to ensure data freshness.
